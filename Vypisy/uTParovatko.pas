...
procedure TParovatko.sparujPlatbu(Platba : TPlatbaZVypisu);
  ...
  begin
    ...
    begin
      ...
      Platba.zprava := 'kredit ' + FloatToStr(Castka) + ' Kè';
...
begin
  ...
  begin
    ...
    if Assigned(iPDPar.Doklad) then
      ...
      if not(iPDPar.Platba.isVoipKredit) AND not(iPDPar.pdparTyp = 'InternetKredit') then  //tyto podmínky nejsou nutné, Abra by Firm_ID pøebila hodnotou z fa
